...
if __name__ == "__main__":
    ...
    testbed.init_rt(config_path="./scripts/exp/garden_ball.json")
    ...
    # python ./scripts/exp_garden_ball.py --scene ./extra_data/nerf360/garden/35000.msgpack  --mode nerf --load_snapshot ./extra_data/nerf360/garden/35000.msgpack  --width 800 --height 600 --gui
    render_frame = 0
    tqdm_last_update = 0
    if n_steps > 0:
